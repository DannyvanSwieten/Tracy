...
pub struct Material {
    ...
    pub sheen: f32,
    pub clear_coat: f32,
    pub base_color_texture: Option<Arc<Resource<GpuTexture>>>,
    pub metallic_roughness_texture: Option<Arc<Resource<GpuTexture>>>,
    pub normal_texture: Option<Arc<Resource<GpuTexture>>>,
    pub emission_texture: Option<Arc<Resource<GpuTexture>>>,
}
...
impl Material {
    ...
    pub fn with_base_color_texture(mut self, texture: Arc<Resource<GpuTexture>>) -> Self {
        self.base_color_texture = Some(texture);
        self
    }

    pub fn with_normal_texture(mut self, texture: Arc<Resource<GpuTexture>>) -> Self {
        self.normal_texture = Some(texture);
        self
    }

    pub fn with_metallic_roughness_texture(mut self, texture: Arc<Resource<GpuTexture>>) -> Self {
        self.metallic_roughness_texture = Some(texture);
        self
    }

    pub fn with_emission_texture(mut self, texture: Arc<Resource<GpuTexture>>) -> Self {
